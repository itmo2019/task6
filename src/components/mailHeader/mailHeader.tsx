...
const MailHeader = (props: Props) => {
  ...
  const { theme, filterText, filterProgress,
    changeFilterText, clearFilterText, onThemeBtnClick } = props;
  ...
  return (
    <header className={styles.box}>
      ...
      <div className={styles.rightBox}>
        <Search className={styles.search} theme={theme} filterText={filterText}
          filterProgress={filterProgress} onChange={changeFilterText} clearText={clearFilterText} />
